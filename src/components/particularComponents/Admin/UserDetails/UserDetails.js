  ...
  const Confirm = ()=>{
    ...
    return (
        <Box padding={10}>
           <Grid container marginTop={10}>
            <Grid item xs={12} md={6}>
                <Box>
                    <Avatar src={user.profile} alt={`${user.firstName} ${user.lastName}`}   sx={{
       ...
       <ListItem>
        ...
        <ListItemText primary="Numéro de téléphone" secondary={user.phoneNumber} />
      </ListItem>
       <ListItem>
        <ListItemAvatar>
           <Avatar>
        ...
        <ListItemText primary="Wilaya du chauffeur" secondary={user.city} />
      </ListItem>
