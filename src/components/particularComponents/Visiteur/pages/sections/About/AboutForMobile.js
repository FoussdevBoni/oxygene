...
const AboutForMobile = () => {
  return (
   <div style={{marginTop:'1px',}} className='p-4 '>
  ...
  <img src={aboutImage.img} className="h-full w-full object-cover" />
    ...
    <Separator  title='Nos services'/>
     ...
     <div className="h-64  flex items-center justify-center">
        ...
        <img src= {aboutImage.img2}  className="h-full w-full object-cover" />
    ...
    <div  style={{ justifyContent:'space-evenly'}}>
     ...
     <div className="h-64  flex items-center justify-center">
                ...
                <img src= {aboutImage.img1}  className="h-full w-full object-cover" />
     ...
     <div  style={{ justifyContent:'space-evenly'}}>
      ...
      <h2>Nos services d'achat d'urgence</h2>
       ...
       <div className="h-64  flex items-center justify-center">
                ...
                <img src= {aboutImage.img3}  className="h-full w-full object-cover" />
